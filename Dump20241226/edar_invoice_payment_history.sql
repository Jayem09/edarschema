...
CREATE TABLE `invoice_payment_history` (
  ...
  KEY `FK_invoice_payment` (`invoice_id`),
  CONSTRAINT `FK_invoice_payment` FOREIGN KEY (`invoice_id`) REFERENCES `invoice` (`invoice_id`)
...
LOCK TABLES `invoice_payment_history` WRITE;
/*!40000 ALTER TABLE `invoice_payment_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `invoice_payment_history` ENABLE KEYS */;
UNLOCK TABLES;
